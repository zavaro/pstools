...
Write-HostCenter "SCCMStuckProgramAssistant`n"
Write-HostCenter "Matthew Allbright // version 2023.01.19`n"
...
$applicationsAvailable = $(Get-WmiObject -Namespace "root\ccm\clientSDK" -Class CCM_Application -ComputerName $computer | Where-Object { $_.EvaluationState -notlike "3" -and $_.EvaluationState -notlike "1" } | ForEach-Object { $_.Name })
echo "`n"
echo "---------------"
echo "`n"
...
$application = (Get-WmiObject -ClassName CCM_Application -Namespace "root\ccm\clientSDK" -ComputerName $computer | Where-Object {$_.Name -like "*$applicationName*"})
